import { Mail, Lock, User, ArrowRight, Activity, Cpu, Database, Shield } from 'lucide-react';
...
export function RegisterPage() {
  ...
  return (
    <AuthSplitLayout>
      ...
      <div className="mb-8">
        <h2 className="mb-2 text-3xl font-bold text-slate-900">Create an account</h2>
        <p className="text-slate-500">Join the SRE Portal to manage active incidents.</p>
      </div>
