import { Mail, User, Users, ArrowRight, Activity, Cpu, Database, Shield } from 'lucide-react';
import { Link, useNavigate } from 'react-router-dom';
import { useState } from 'react';
import { AuthSplitLayout } from '../../layouts/AuthSplitLayout.jsx';

export function OrganiztionPage() {
  ...
  return (
    <AuthSplitLayout>
      ...
      <div className="mb-8">
        <h2 className="mb-2 text-3xl font-bold text-slate-900">Almost there!</h2>
        <p className="text-slate-500">Just a few more details to set up your organization.</p>
      </div>
